...
module.exports = {
  config: {
    name: "info",
    aliases: ["admininfo", "botinfo", "shishir", "info"],
    version: "1.4",
    author: "亗🅼🅰ᥫᩣ🅼ᥫᩣ🆄🅽×͜×",
    countDown: 5,
    role: 0,
  ...
  onStart: async function ({ message }) {
    ...
    // OWNER INFO
    const authorName = "×᷼×S༶H༶I༶S༶H༶I༶R༶ ☆";
    const ownAge = "17+";
    const messenger = "https://www.facebook.com/share/1JKULbyLLa/";
    const authorFB = "Your aBBu'z";
    const authorNumber = "+8801749316--26";
    const Status = "Single";
