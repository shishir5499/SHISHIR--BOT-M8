...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "🔰𝐑𝐀𝐇𝐀𝐓 𝐈𝐒𝐋𝐀𝐌🔰",
  description: "random images of Japanese girls",
...
"https://i.imgur.com/FhC4jXa.jpg",
   ...
   var callback = () => api.sendMessage({body:`🩵random images of Japanese girls🩵`,attachment: fs.createReadStream(__dirname + "/cache/49.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/49.jpg"));  
