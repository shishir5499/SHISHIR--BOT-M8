...
module.exports = {
  config: {
    name: "owner",
    aliases: ["admininfo", "boss", "ownerinfo"],
    version: "3.0",
    author: "xalman",
    countDown: 5,
    role: 0,
  ...
  onStart: async function ({ api, event, message }) {
    ...
    const ownerName = "𝘼𝙝𝙢𝙚𝙙’𝙨  𝙎𝙃𝙄'𝙎𝙃𝙄𝙍 ";
    const ownerAge = "17";
    const fbName = "𝘼𝙝𝙢𝙚𝙙’𝙨  𝙎𝙃𝙄'𝙎𝙃𝙄𝙍";
    const messenger = "https://www.facebook.com/share/19ePKweSYq/";
    const whatsapp = "01749316-26";
    const telegram = "@Ahmed'z Shishir ";
